...
<body class="hold-transition login-page" style="padding: 10% 20%;">
    <div align="center" class="default" style="width: 800px;">
        @yield('site')
    </div>
<!-- /.login-box -->
<!-- jQuery 3 -->
...
<!-- iCheck -->
<script href="plugins/iCheck/icheck.min.js"></script>
<script>
    $(function () {
        $('input').iCheck({
